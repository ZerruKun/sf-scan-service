...
// import testImg from "../../../../images/test/bear.jpeg"
...
const Document = (props) => {
  ...
  return (
    <div className={styles.general}>
      ...
      {props.isTechNews ? <span className={styles.kind}>Технические новости</span> : <></>}
      ...
      <div className={styles.bottomSection}>
        <Link to={props.link} target={'_blank'}>Читать в источнике</Link>
